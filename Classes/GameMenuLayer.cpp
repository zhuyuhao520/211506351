...
bool GameMenuLayer::init()
{
	do 
	{
		...
		titleSprite->setPosition(ccp(winSize.width/2, winSize.height * 0.76));
...
void GameMenuLayer::createMenu(void)
{
	...
	startNormalTextSprite->setPosition(ccp(startNormalBgSize.width / 2, startNormalBgSize.height / 2 + 21));
	...
	startSelectedTextSprite->setPosition(ccp(startNormalBgSize.width / 2, startNormalBgSize.height / 2 + 21));
	...
	sceneNormalTextSprite->setPosition(ccp(sceneNormalBgSize.width / 2, sceneNormalBgSize.height / 2 + 4));
	...
	sceneSelectedTextSprite->setPosition(ccp(sceneNormalBgSize.width / 2, sceneNormalBgSize.height / 2 + 4));
